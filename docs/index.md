...
* The pygeoapi [admin API](https://docs.pygeoapi.io/en/latest/admin-api.html) must be enabled on the pygeoapi running instance.
...
![portuguese title](img/multilingual.png)
